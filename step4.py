...
channel = flowmsm.channel.Channel({dV:'{}.{}.step2.{}mV.pk'.format(prefix, prefix_fitting_output, dV) for dV in dVs}, channel_name, dVs_fitting = dVs_fitting, use_md_data = False)
